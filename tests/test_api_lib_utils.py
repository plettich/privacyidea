...
class UtilsTestCase(MyApiTestCase):
    ...
    def test_01_getParam(self):
        ...
        self.assertRaises(ParameterError, getParam, {"serial": ""}, "serial",
                          optional=False, allow_empty=False)

        # check for allowed values
        v = getParam({"sslverify": "0"}, "sslverify", allowed_values=["0", "1"],
                     default="1")
        self.assertEqual("0", v)

        v = getParam({"sslverify": "rogue value"}, "sslverify",
        ...
        v = getParam({}, 'sslverify')
        self.assertEqual(None, v)
        v = getParam({}, 'sslverify', default='')
        self.assertEqual('', v, v)
        v = getParam({}, 'sslverify', default=0)
